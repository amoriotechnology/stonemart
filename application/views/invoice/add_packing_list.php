                             ...
                             <thead>
                                ...
                                <tbody id="">
                                    <tr>
                                        ...
                                        <select name="product_name"  required class="form-control productSelection"  id="product_name" tabindex="5" class="form-control" >
...
newdiv.innerHTML ='<div class="crate_wrap" id="crate_wrap_'+ incre +'" style="border: 1px solid #ddd;padding: 6px;margin: 5px;"><div class="table-responsive" id="quotation_service1"><input type="hidden" value="Bundle '+incre+'"  name="bundle[]" id="bundle_'+incre+'" /> <table class="table table-bordered table-hover" id="packingListTable">  <thead> <tr><th colspan="3"  class="bundlelable">Bundle '+incre+'</th></tr> <tr>  <th class="text-center" width="15%">Product<i class="text-danger">*</i></th>   <th class="text-center" width="15%">Description<i class="text-danger">*</i></th>   <th class="text-center" width="15%">Thickness<i class="text-danger">*</i></th>    </tr> </thead>  <tbody id=""> <tr>   <td class="span3 supplier"> <select name="product_name"  required class="form-control productSelection"  id="product_name_'+ incre +'" tabindex="5" onchange="product_detail('+ incre +');" class="form-control" > <option value="Select the Product" selected>Select the Product</option> <?php foreach ($products as $ppn) { ?> <option value="<?php echo $ppn["product_name"]."-".$ppn["product_model"]; ?>"><?php echo $ppn["product_name"]."-".$ppn["product_model"]; ?></option> <?php }?> </select>  <input type="text"  name="product_id[]" id="prod_id_'+incre+'" />      <input type="hidden" class="sl" value="1">   </td>  <input type="hidden" id="invoice_hdn"/> <input type="hidden" id="invoice_hdn1"/> <td class="span3 supplier"> <input type="text" name="description" required class="form-control" placeholder="<?php echo display("description") ?>"  tabindex="5" >  </td>   <td class="span3 supplier"> <input type="text" name="thickness" required class="form-control" placeholder="Thickness"  tabindex="5" >  </td>  </tr>  </tbody>  </table> </div>      <div class="table-responsive" id="quotation_service1"> <table class="table table-bordered table-hover" id="packingListTable">   <thead> <tr>   <th class="text-center" width="10%">Serial No<i class="text-danger">*</i></th> <th class="text-center">SLAB NO</th> <th class="text-center">Net Measurement (Inches)<i class="text-danger">*</i></th> <th class="text-center"  style="width:200px;">Area (Sq. Ft)<i class="text-danger">*</i></th>  <th class="text-center"><?php echo display("action") ?></th> </tr> </thead> <tbody class="addPurchaseItem" id="addPurchaseItem'+ incre +'"> <tr> <td class="wt" style="text-align:center;">   <input type="hidden" id="bundle[]" name="bundle[]" value="Bundle '+incre+'" class="form-control text-right" placeholder="" /> <input type="hidden" id="serial_number[]" name="serial_number[]" value="1" class="s1 form-control text-right" placeholder="" /> </td>  <td class="wt"> <input type="text" name="slab_no[]" id="available_quantity_1" class="form-control text-right stock_ctn_1" placeholder="0.00" /> </td>     <td class="text-right" style="display: flex;"> <input type="text" name="width[]" id="cartoon_1"  class="form-control text-right store_cal_1" onkeyup="calculate_store(1);" onchange="calculate_store(1);" placeholder="Width" value=""  tabindex="6" style="width: 50%;"/>  <input type="text" name="height[]" id="product_rate_1"  class="form-control text-right store_cal_1" onkeyup="calculate_store(1);" onchange="calculate_store(1);" placeholder="Height" value=""  tabindex="6" style="width: 50%;"/>   </td>      <td class="text-right"> <input class="form-control total_price text-right" type="text" name="total_price[]" id="total_price_'+ incre +'" value="0.00" readonly="readonly" /> </td>  <td> <button  class="btn btn-danger text-right red" type="button" value="<?php echo display("delete")?>" onclick="deleteRow(this)" tabindex="8"><i class="fa fa-close"></i></button> </td> </tr> </tbody> <tfoot> <tr>  <td class="text-right" colspan="3"><b><?php echo display("total") ?>:</b></td>  <td class="text-right"> <input type="text" id="Total" class="text-right form-control" name="total" value="0.00" readonly="readonly" /> </td> <td> <button type="button" id="add_invoice_item" class="btn btn-info" name="add-invoice-item"  onClick=\'addpackingList("addPurchaseItem'+ incre +'");\'   tabindex="9"/><i class="fa fa-plus"></i></button> <input type="hidden" name="baseUrl" class="baseUrl" value="<?php echo base_url();?>"/></td> </tr>    </tfoot> </table> </div>   </div>';
