...
<?php  foreach($purchase_info as $p_info){ ?>
   ...
   <td class="wt">
                        <input type="text" name="bundle_no[]" id="bundle_no_1" value="<?php  echo $p_info['no_of_bundle']; ?>"  class="form-control text-right bundle_no" placeholder="0.00" />
               </td>
       ...
       <td class="wt">
                <input type="text" name="q_per_package[]" id="q_per_package_1"   value="<?php  echo $quantity_per_package; ?>"  onkeyup="total_amt(1);"  class="form-control text-right stock_ctn_1" placeholder="0.00" />
       </td>
