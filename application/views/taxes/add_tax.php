                   ...
                   <?php echo form_open_multipart('Caccounts/tax_entry',array('class' => 'form-vertical','id' => 'tax_entry' ))?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                            <label for="isshow" class="form-label">Sales Rate</label>
                               <div class="">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                            <label for="isshow" class="form-label">Account</label>
                               <div class="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                            <label for="isshow" class="form-label">Show Tax On Return Line</label>
                               <div class="">
                                <select class="form-control">
