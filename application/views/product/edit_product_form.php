                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <label for="quantity" class="col-sm-2 col-form-label"><?php echo 'Quantity' ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-10">
                                        <input class="form-control" name="quantity" type="number" id="quantity" placeholder="Enter Product Quantity only" required tabindex="1" value="{p_quantity}" >
                                    </div>
                                </div>
                            </div>
                        </div>
