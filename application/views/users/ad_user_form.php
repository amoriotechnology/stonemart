                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('User/insert_users');?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="" name="fname" re class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="phone" class="form-control" required>
                        </div>
                            <div class="form-group">
                            <label>Gender</label>
                        ...
                        <div class="form-group">
                            <label></label>
                            <input type="submit"  name="Save" value="Save1" class="btn btn-success">
                        </div>
                   <?php echo form_close(); ?>
                    </div>
